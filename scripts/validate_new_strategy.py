...
def main() -> None:
    ...
    (Path(__file__).resolve().parents[1] / "coordination" / "phase3_new_strategy_result.json").write_text(json.dumps({"experiment_id": "exp-20260329-009-ma10-ma30-cross", **metrics}, ensure_ascii=False, indent=2), encoding="utf-8")
